...
import com.godfrey.Student;
import com.godfrey.sort.cmp.SelectionSort;
import com.godfrey.sort.cmp.ShellSort;
...
public abstract class Sort<T extends Comparable<T>> implements Comparable<Sort<T>> {
    ...
    private boolean isStable() {
        if (this instanceof RadixSort1 || this instanceof RadixSort2) {
            return true;
        }
